            ...
            if usrCount[0] > 0:
                ...
                if password != '':
                    ...
                    if values is not None:
                        userID = values[0]
                        log.logger.insertlog(conn=conn, cur=cur, userID=userID, transID=0, message="User Logged in "
                                                                                                   "Successfully")
                ...
                raise Exception("No Account associated for the mentioned Usernname")
    ...
    def register(conn, cur):
        try:
            ...
            if usr_count is not None and usr_count[0] == 0:
                ...
                cur.execute(
                    "INSERT INTO Users (Name, Gender, DOB, Email, UserName, Password, PremiumUser) VALUES (?, ?, ?, ?, ?, ?, 'N')",
        ...
        try:
            ...
            if values is not None:
                ...
                if pwd_rst > 0:
                    ...
                    raise dbe.OperationalError("Password was not updated secessfullly")
            else:
                raise Exception("No Data found for the mentioned Usernname and Date of Birth")
